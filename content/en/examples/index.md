...
This example demonstrates conjugate heat transfer (CHT) in a shell-and-tube heat
exchanger. The case is based on a SimScale GmbH case [73].

{{< figure src="/images/fig10_heat_exchanger_geometry.png" >}} _Figure 10:
Geometry of the shell-and-tube heat exchanger_

{{< figure src="/images/fig11_heat_exchanger_mesh.png" >}} _Figure 11:
Computational mesh of the heat exchanger_

{{< figure src="/images/fig12_heat_exchanger_temp.png" >}} _Figure 12: Final
temperature distribution in the heat exchanger_
...
### Table 8: Thermophysical properties (fluid vs solid)

| Property     | Symbol | Unit  | Fluid    | Solid |
| ------------ | ------ | ----- | -------- | ----- |
| Density      | ρ      | kg/m³ | 1027     | 8960  |
| Conductivity | k      | W/mK  | 0.668    | 401   |
| Viscosity    | μ      | kg/ms | 3.645e−4 | –     |
| Cp           | cp     | J/kgK | 4195     | 385   |

**Key setup snippet: multiRegionProperties**
